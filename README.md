<p align="center">
	<img src="https://raw.githubusercontent.com/MarcoRezkallah/helm-gcs/master/assets/helm-gcs-logo.png" alt="helm-gcs logo"/>
</p>

# helm-gcs

![Helm3 supported](https://img.shields.io/badge/Helm%203-supported-green)
![GitHub release (latest by date)](https://img.shields.io/github/v/release/MarcoRezkallah/helm-gcs)
[![Build Status](https://github.com/MarcoRezkallah/helm-gcs/workflows/release/badge.svg)](https://github.com/MarcoRezkallah/helm-gcs/releases/latest)
...
```shell
$ helm plugin install https://github.com/MarcoRezkallah/helm-gcs.git
```
...
```shell
$ helm plugin install https://github.com/MarcoRezkallah/helm-gcs.git --version 0.4.0
```
...
```shell
helm plugin install https://github.com/MarcoRezkallah/helm-gcs.git --version 0.2.2 # helm 2 compatible
```
